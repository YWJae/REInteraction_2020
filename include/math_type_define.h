...
namespace DyrosMath
{
	...
	//static Eigen::Vector3d getPhi(Eigen::Matrix3d rotation_0, Eigen::Matrix3d rotation_f)
	//{
	//	Eigen::Matrix3d rotation_desired, s1_skew, s2_skew, s3_skew;

	//	//rotation_desired = rotation_f * rotation_0.transpose(); // test ÇØº¼ °Í
	//	rotation_desired = rotation_f;

	//	s1_skew = skew(rotation_desired.col(0));
	//	s2_skew = skew(rotation_desired.col(1));
	//	s3_skew = skew(rotation_desired.col(2));
	...
	//	s1f = s1_skew * rotation_desired.col(0);
	//	s2f = s2_skew * rotation_desired.col(1);
	//	s3f = s3_skew * rotation_desired.col(2);
